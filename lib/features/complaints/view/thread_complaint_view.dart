...
import 'package:inldsevak/features/complaints/model/response/complaint_by_thread.dart' as threads;
...
class _ThreadComplaintViewState extends State<ThreadComplaintView>
  ...
  void _showReplyForm([ThreadViewModel? provider]) {
    final threadProvider = provider ?? _threadViewModel ?? context.read<ThreadViewModel>();
      ...
      child: SafeArea(
        ...
        child: Scaffold(
          ...
          appBar: commonAppBar(
            child: TranslatedText(
              text:
                  _decodeUtf8(widget.data.messages?.first.subject) ?? '',
        ...
        body: ChangeNotifierProvider(
          ...
          builder: (contextP, child) {
            ...
            final isResolved = widget.data.status?.toLowerCase() == 'resolved' ||
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if (isResolved && index == 0) {
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: AppPalettes.primaryColor.withOpacity(0.1),
                                    borderRadius: BorderRadius.circular(Dimens.radiusX2),
                                    border: Border.all(
                                      color: AppPalettes.primaryColor.withOpacity(0.3),
                                      width: 1,
                                    ),
                                  ),
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Flexible(
                                        child: TranslatedText(
                                          text: localization.your_complaint_has_been_resolved,
                                          style: textTheme.bodyMedium?.copyWith(
                                            color: AppPalettes.primaryColor,
                              ...
                              final threadIndex = isResolved ? index - 1 : index;
                              if (threadIndex < 0 || threadIndex >= provider.threadsList.length) {
                              ...
                              child: GestureDetector(
                                onTap: value.isLoading
                                    ...
                                    : () {
                                        ...
                                        final messageText = value.nextThreadController.text.trim();
                                        debugPrint("📤 Main thread view - Message being sent: '$messageText'");
              ...
              listItemBuilder: (context, status, _, __) {
                ...
                switch (status) {
                  ...
                  case 'resolved':
                    ...
                    break;
                  default:
                    statusText = status.split('-').map((word) => 
              ...
              builder: (context, provider, _) {
                return CommonButton(
                  ...
                  onTap: () async {
                    ...
                    if (messageController.text.trim().isEmpty && provider.multipleFiles.isEmpty) {
                      CommonSnackbar(
                    ...
                    debugPrint("📤 Controller text before send: '${provider.nextThreadController.text}'");
