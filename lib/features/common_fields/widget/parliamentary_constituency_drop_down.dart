...
class ParliamentaryConstituencyDropDownWidget extends StatefulWidget {
  ...
  final Function(Constituency?)? onChange;

  const ParliamentaryConstituencyDropDownWidget({
    super.key,
  ...
  @override
  State<ParliamentaryConstituencyDropDownWidget> createState() =>
      _ParliamentaryConstituencyDropDownWidgetState();
}

class _ParliamentaryConstituencyDropDownWidgetState
    extends State<ParliamentaryConstituencyDropDownWidget> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<ConstituencyViewModel>().parliamentaryConstituencyLists.add(
        widget.initialData,
      );
