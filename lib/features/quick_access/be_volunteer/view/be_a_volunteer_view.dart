                      ...
                      Consumer<BeAVolunteerViewModel>(
                        builder: (context, value, _) {
                          return FormCommonDropDown<String>(
                            key: ValueKey('gender_${value.genderController.value}'),
                            isRequired: true,
                            ...
                            onChanged: (selectedValue) {
                              ...
                              final vm = context.read<BeAVolunteerViewModel>();
                              vm.notifyListeners();
                            },
                                ...
                                children: [
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: FormTextFormField(
                                          controller: value.hoursPerWeekController,
                                          hintText: "0",
                                          ...
                                          fillColor: AppPalettes.liteGreenColor,
                                          ...
                                          suffixWidget: Padding(
                                            padding: EdgeInsets.only(top: Dimens.paddingX3,bottom: Dimens.paddingX3),
                                            child: TranslatedText(
                                              text: "hours",
                                              style: context.textTheme.bodySmall?.copyWith(
                                          ...
                                          onChanged: (text) {
                                            if (text != null && text.isNotEmpty) {
                                              final hours = double.tryParse(text) ?? 0;
                                              value.hoursPerWeek = hours.clamp(0, 160);
                                            } else {
                                              value.hoursPerWeek = 0;
                                            }
                                            field.didChange(value.hoursPerWeek);
                                            field.validate();
                                          },
                                        ),
                                      ),
                                  ...
                                  if (field.hasError)
                                    Padding(
                                      ...
                                      child: Text(
                                        field.errorText ?? localization.hours_per_week_validator,
                                        style: context.textTheme.bodySmall?.copyWith(
                                          color: AppPalettes.redColor,
                                        ),
                                      ),
