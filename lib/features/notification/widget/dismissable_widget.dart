...
class NotificationCard extends StatelessWidget {
  ...
  complaint.Data _buildComplaintArgs(BuildContext context, String complaintId) {
    try {
  ...
  void _handleNavigation(BuildContext context) {
    ...
    if (module == 'nearestpartymember') {
      ...
      final member = _buildNearestMemberArgs(
        context,
        moduleId,
  ...
  String _getNotificationMessage() {
    ...
    final isAppointmentNotification =
        notification.type?.toLowerCase() == 'appointment';
    ...
    if (isAppointmentNotification && notification.appointmentIdObject != null) {
      ...
      if (appointmentDate != null &&
        ...
        try {
          ...
          if ((isApproved || status == 'rescheduled') &&
              timeSlot != null &&
              timeSlot.trim().isNotEmpty) {
    ...
    if (isAppointmentNotification && notification.metadata != null) {
      ...
      final isApproved =
          (notification.title?.toLowerCase().contains('approved') ?? false) ||
          (notification.message?.toLowerCase().contains('approved') ?? false);
      final isRescheduled =
          (notification.title?.toLowerCase().contains('rescheduled') ??
              false) ||
          (notification.message?.toLowerCase().contains('rescheduled') ??
              false) ||
  ...
  String _getNotificationTitle() {
    ...
    return isAppointmentNotification ? _removeMlaFromText(title) : title;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final isChatNotification =
        module == 'wallofhelp' || module == 'nearestpartymember';
    ...
    final isNotifyRepresentative =
        module == 'notifyrepresentative' ||
    ...
    final shouldForceTranslate =
        isNotifyRepresentative || isComplaint || !isChatNotification;
              ...
              child: Column(
                ...
                children: [
                  ...
                  ReadMoreWidget(
                    ...
                    namesToPreserve:
                        notification.metadata?.userName != null &&
                            notification.metadata!.userName!.trim().isNotEmpty
