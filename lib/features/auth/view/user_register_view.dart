        ...
        builder: (context, child) {
          ...
          return Scaffold(
                ...
                return SingleChildScrollView(
                  ...
                  child: Consumer<UserRegisterViewModel>(
                    builder: (context, provider, _) {
                      debugPrint(
                        "🟡 [UserRegisterView] Consumer rebuild - aadharImage: ${provider.aadharImage?.path}, voterIdImage: ${provider.voterIdImage?.path}",
                      );
                      return Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            FormTextFormField(
                              ...
                              validator: (text) => text?.validate(
                                argument:
                                    localization.voter_id_validator ??
                                    "Please enter voter ID",
                              ),
                              onChanged: (value) =>
                                  provider.generateVoter(value),
                            ),
                            UploadImageWidget(
            ...
            bottomNavigationBar: SafeArea(
              child: Consumer2<UserRegisterViewModel, MapSearchViewModel>(
                  ...
                  return Padding(
                    ...
                    child: CommonButton(
                      ...
                      onTap: () async {
                        ...
                        final parliamentaryId =
                            parliamentaryconstituencyController.value?.sId;

                        debugPrint('Assembly Constituency ID: $assemblyId');
                        debugPrint(
                          'Parliamentary Constituency ID: $parliamentaryId',
                        );
                        debugPrint(
                          'Assembly Constituency Value: ${assemblyconstituencyController.value}',
                        );
