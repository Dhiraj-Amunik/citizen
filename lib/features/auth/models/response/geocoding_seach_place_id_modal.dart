class GeocodingSeachPlaceIdModal {
  List<Null>? htmlAttributions;
  Result? result;
  String? status;

  GeocodingSeachPlaceIdModal({this.htmlAttributions, this.result, this.status});

  GeocodingSeachPlaceIdModal.fromJson(Map<String, dynamic> json) {
